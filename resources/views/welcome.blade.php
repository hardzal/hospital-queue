...
<body class="antialiased">
    <div
        ...
        <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
            ...
            <a class="ml-4 text-sm text-gray-700 dark:text-gray-500 underline" href="{{ route('logout') }}" onclick="event.preventDefault();
            ...
            @else
            <a href="{{ route('patient.login') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Log in</a>
