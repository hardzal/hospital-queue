...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Memperbaharui Data Rekam Medik Pasien</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                    <li class="breadcrumb-item active">Patient Medical Record Update</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <select name="patient_id" id="patient_id"
                        ...
                        @if(old('patient_id', $record->patient_id) == $patient->id)
                ...
                <div class="form-group">
                    ...
                    <select name="doctor_schedule_id"
                        ...
                        @endphp
                        @if(old('doctor_schedule_id', $record->doctor_schedule_id) == $item->id)
                ...
                <div class="form-group">
                    ...
                    <select name="type" id="type" class="form-control @error('type') is-invalid @enderror">
                        ...
                        <option value="BPJS" {{ $record->type == "BPJS" ? "selected" : "" }}>BPJS</option>
                        <option value="UMUM" {{ $record->type == "UMUM" ? "selected" : "" }}>Umum</option>
                    </select>
                    @error('type')
                    <div class="invalid-feedback">
                        {{ $message }}
