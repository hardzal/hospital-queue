...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Memperbaharui Data Jadwal Dokter</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                    <li class="breadcrumb-item active">Doctor Schedule Edit</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
...
<section class="content">
    <div class="card">
        ...
        <form method="POST" action="{{ route('doctorschedules.update', $doctorschedule->id) }}">
            @csrf
            @method('PUT')
            <div class="card-body">
                <div class="form-group">
                    ...
                    <select name="schedule_id" class="form-control @error('schedule_id') is-invalid @enderror">
                        ...
                        @if(old('schedule_id', $doctorschedule->schedule_id) == $schedule->id)
                ...
                <div class="form-group">
                    ...
                    <select name="user_id" class="form-control @error('user_id') is-invalid @enderror">
                        ...
                        @if(old("user_id", $doctorschedule->user_id) == $user->id)
                ...
                <div class="form-group">
                    ...
                    <select name="polyclinic_id" class="form-control @error('polyclinic_id') is-invalid @enderror">
                        ...
                        @if(old('polyclinic_id', $doctorschedule->polyclinic_id) == $polyclinic->id)
                ...
                <div class="form-group">
                    ...
                    <input type="number" value="{{ old('quota', $doctorschedule->quota) }}" name="quota"
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" id="description" cols="30" rows="5"
                        class="form-control @error('description') is-invalid @enderror">{{ old('description', $doctorschedule->description) }}</textarea>
                    @error('description')
                    <div class="invalid-feedback">
                        {{ $message}}
                    </div>
                ...
                <div class="form-group">
                    ...
                    <select name="status" class="form-control @error('status') @enderror" id="status">
                        ...
                        <option value=1 @if(old('status', $doctorschedule->status)==1) selected @endif>Aktif</option>
